...
print(eigenvalues)
print("A"*32)
print("Valores propios --->",eigenvectors)

# los normaliza
eigenvalues_normalized = eigenvalues / eigenvalues.sum()
print("d"*32)
print(eigenvalues_normalized.shape)
print("Valores propios normalizados --->", eigenvalues_normalized)
      
valor1 = pd.DataFrame([3.2032, 5.7588, -0.75345, -0.61251]).T
print(valor1.shape)

print(valor1)

print("con valores propios. ----> ", np.dot(valor1,eigenvalues ))



data_vector = np.array([3.2032, 5.7588, -0.75345, -0.61251])
print(data_vector.shape)

# Proyección sobre el tercer componente principal (PC-3)
pc3_vector = eigenvectors[:, 2]  # Tercer componente
projection_pc3 = np.dot(data_vector, pc3_vector)

print("Con vectores propios ----->  ", projection_pc3)
